...
void static_UI_func()
{
	...
	//中间
	//Aim 竖线
	Line_Draw(&gAimVertL, "001", UI_Graph_ADD, 2, UI_Color_Orange, 1, 960-9+5, 540+45, 960-9+5, 500); // end y 0
	...
	Line_Draw(&gAimHorizL8m, "007", UI_Graph_ADD, 2, UI_Color_Green, 4, (960-7-9+5), (540+41), (960+7-9+5), (540+41)); // width 1
